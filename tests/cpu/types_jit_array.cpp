...
// CHECK: A: [0] = 3, [1] = 2, [2] = 1,
// CHECK: [proteus][JitEngineHost] MemoryCache procuid 0 hits 0 accesses 10
// CHECK-COUNT-10: [proteus][JitEngineHost] MemoryCache procuid 0 HashValue {{[0-9]+}} NumExecs 1 NumHits 0
// CHECK-FIRST: [proteus][JitEngineHost] StorageCache procuid 0 hits 0 accesses 10
// CHECK-SECOND: [proteus][JitEngineHost] StorageCache procuid 0 hits 10 accesses 10
