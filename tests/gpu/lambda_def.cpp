...
// CHECK: [proteus][JitEngineDevice] MemoryCache procuid 0 hits 2 accesses 3
// CHECK: [proteus][JitEngineDevice] MemoryCache procuid 0 HashValue {{[0-9]+}} NumExecs 3 NumHits 2
