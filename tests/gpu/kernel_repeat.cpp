...
// CHECK: [proteus][JitEngineDevice] MemoryCache procuid 0 hits 999 accesses 1000
// CHECK: [proteus][JitEngineDevice] MemoryCache procuid 0 HashValue {{[0-9]+}} NumExecs 1000 NumHits 999
