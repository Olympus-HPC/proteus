...
// CHECK-COUNT-2: [proteus][DispatcherHost] MemoryCache procuid 0 HashValue {{[0-9]+}} NumExecs 1 NumHits 0
// CHECK-FIRST: [proteus][DispatcherHost] StorageCache procuid 0 hits 1 accesses 2
