...
// CHECK-NEXT: V 142
// CHECK-NEXT: V 123
// CHECK-NEXT: [proteus][DispatcherHost] MemoryCache procuid 0 hits 0 accesses 4
// CHECK-COUNT-4: [proteus][DispatcherHost] MemoryCache procuid 0 HashValue {{[0-9]+}} NumExecs 1 NumHits 0
